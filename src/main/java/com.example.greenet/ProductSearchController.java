...
public class ProductSearchController {
    ...
    public void initialize() {
        ...
        publicacionesBase.add(new PublicacionTecnologia("Laptop Gaming", "Laptop reacondicionada con garantía", true, "MarcaX", "ModeloY", FachadaImagen.codificarImagenAString(new byte[0])));
        publicacionesBase.add(new PublicacionRopa("Camisa futbol colombiano", "Camiseta oficial de la selección", "Algodón", FachadaImagen.codificarImagenAString(new byte[0])));
        publicacionesBase.add(new PublicacionHogar("Lámpara de oso", "Lámpara decorativa restaurada", "Madera", FachadaImagen.codificarImagenAString(new byte[0])));
