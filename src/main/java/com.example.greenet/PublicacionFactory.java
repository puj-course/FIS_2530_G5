...
public class PublicacionFactory implements AbstractFactoryPublicacion {
    ...
    @Override
    public Publicacion crearPublicacionTecnologia(String titulo, String descripcion, byte[] imagen, 
    ...
    @Override
    public Publicacion crearPublicacionRopa(String titulo, String descripcion, byte[] imagen, 
    ...
    @Override
    public Publicacion crearPublicacionHogar(String titulo, String descripcion, byte[] imagen, 
    ...
    public Publicacion crearPublicacion(String categoria, String titulo, String descripcion, 
                                      byte[] imagen, int publicadorId, String... parametros) {
