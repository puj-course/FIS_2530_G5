...
begin
    ...
    insert into usuarios(nombre, apellidos, fechanacimiento, tipo_id, numero_doc, correo, contraseña, rol_id, fechacreacion, estado)
    values (p_nombre, p_apellidos, p_fechanacimiento, v_tipo_doc, v_numero_doc, p_correo, v_contraseña, v_tipocuenta, now(), 1);
